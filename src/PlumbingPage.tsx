...
const PlumbingPage: React.FC<PlumbingPageProps> = ({
  onBack,
  onGetInTouch,
}) => {
  return (
      ...
      <section className="lux-hero">
        <div style={{ width: "100%" }}>
          ...
          <motion.p
            ...
            A complete "Done-For-You" AI system that handles all communication,
            booking, and billing so you never miss a payday.
          </motion.p>
        </div>
      </section>
