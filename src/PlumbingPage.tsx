...
const PlumbingPage: React.FC<PlumbingPageProps> = ({ onBack, onGetInTouch }) => {
  return (
    <div className="hvac-lux-root selection:bg-[#E7E5E4]">
      ...
      <section className="lux-hero">
        <div style={{ width: '100%' }}>
          ...
          >
            Capture every paid job. <br /> Stop missing calls.
          </motion.h1>
          ...
          >
            A complete "Done-For-You" AI system that handles all communication, booking, and billing so you never miss a payday.
          </motion.p>
        </div>
      </section>
      ...
      <FeatureSection
        ...
        system="An AI receptionist that answers phone calls 24/7 and an outbound dialer that calls web leads within 30 seconds."
        impact="Ensures a human-like response immediately, preventing customers from calling a competitor."
      />
      ...
      <FeatureSection
        ...
        system="A qualification bot that reviews customer photos to provide rough estimates and collects deposits over $1,000."
        impact="Filters out 'tire kickers' and secures payment before you even start looking for parts."
      />

      <FeatureSection
        index={2}
        icon="⭐"
        title="Invoicing & Reviews"
        system="An automated follow-up system that chases unpaid invoices via text/email and requests Google reviews."
        impact="Eliminates administrative work and constantly reactivates old customers for new work."
      />
      ...
      <section className="lux-cta-snap">
        ...
        >
          <h2 className="cta-headline">Ready to automate <br /> your business?</h2>
          <motion.div
