...
const RoofingPage: React.FC<RoofingPageProps> = ({ onBack, onGetInTouch }) => {
  return (
    <div className="hvac-lux-root selection:bg-[#E7E5E4]">
      ...
      <section className="lux-hero">
        <div style={{ width: '100%' }}>
          ...
          >
            Capture every roof lead. <br /> Stop losing estimates.
          </motion.h1>
          ...
          >
            A complete automation package that handles bookings, database reactivation, and insurance supplements.
          </motion.p>
        </div>
      </section>
      ...
      <FeatureSection
        ...
        system="An intelligent voice agent that answers every call immediately—day or night. It answers questions, qualifies homeowners, and books estimates directly onto your calendar."
        impact="Ensures you never lose a lead to voicemail and fills your calendar with qualified estimates automatically."
      />

      <FeatureSection
        index={1}
        icon="🏠"
        title="Automated Estimates & Database Reactivation"
        system="A system that provides instant ballpark quotes to new leads and follows up via text and call until they book. It also reaches out to old, dormant customer lists."
        impact="Wakes up dead leads and turns missed opportunities into new appointments without you lifting a finger."
      />

      <FeatureSection
        index={2}
        icon="📋"
        title="Automated Insurance Supplements & Reviews"
        system="An operations tool that builds your insurance supplement packets (photos, code docs, cover letters) and follows up with adjusters until approved."
        impact="Maximizes insurance payouts and automatically captures 5-star Google reviews once the job is complete."
      />
      ...
      <section className="lux-cta-snap">
        ...
        >
          <h2 className="cta-headline">Ready to automate <br /> your roofing business?</h2>
          <motion.div
